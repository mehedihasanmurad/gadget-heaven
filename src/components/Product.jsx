        ...
        <div className="card border lg:w-[310px] mx-5 border-slate-200 shadow-sm">
            ...
            <div className="px-4">
                ...
                <div className="card-actions justify-start">
                    <Link to={`/product/${product_id}`} className="px-7 py-2.5 relative rounded-full my-5 w-38 group overflow-hidden font-medium bg-white border text-purple-600 inline-block">
