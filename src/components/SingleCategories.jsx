        ...
        <div className="card border lg:w-[310px] mx-5 border-slate-200 shadow-sm">
            ...
            <div className="px-4">
                ...
                <div className="card-actions justify-start">
                    <Link to={`/products/${product_id}`} className="px-7 py-2.5 relative rounded-full my-5 w-38 group overflow-hidden font-medium bg-white border text-purple-600 inline-block">
                        <span className="absolute top-0 left-0 flex w-full h-0 mb-0 transition-all duration-200 ease-out transform translate-y-0 bg-[#9538E2] group-hover:h-full opacity-90"></span>
